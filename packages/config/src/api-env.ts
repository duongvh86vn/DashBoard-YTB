...
const httpOriginSchema = z.string().trim().transform((value, context) =>
  parseHttpOrigin(value, context, "APP_PUBLIC_URL"),
);

const allowedOriginsSchema = z.string().min(1).transform((value, context) => {
